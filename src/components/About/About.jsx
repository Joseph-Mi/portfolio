    ...
    const images = [
      ...
      useEffect(() => {
        ...
        if (imageWrapper) {
            ...
            console.error('Element .imageWrapper not found');
        }

        if (imageItems.length === 0) {
            console.error('No child elements found inside .imageWrapper');
        }

        // Clone and append the first perView images to the end of the image list
